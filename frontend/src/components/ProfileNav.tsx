...
const ProfileNav: React.FC = () => {
  ...
  return (
    <div
      ...
      className="relative w-[80%] mx-auto mt-6 flex justify-center items-center p-4 rounded-full border-4 border-gray-800 bg-gradient-to-r from-green-800 via-gray-900 to-black shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
    >
